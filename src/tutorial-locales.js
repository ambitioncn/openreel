...
const EN = {
  ...
  "product-commercial": {
    title: "15-second premium product ad", category: "Commercial", level: "Beginner", duration: "About 15–25 minutes", calls: "Planning + 3 first frames + 3 videos + voice and quality review", outcome: "Create a vertical ad with a hero reveal, material detail, and branded finish.",
    nodes: [["Three-shot ad script", "Shot 1 reveals the product. Shot 2 shows material and benefit details. Shot 3 holds on the product with room for post-production copy."], ["Product hero image", "Unbranded matte-black perfume bottle on a shallow reflective surface, warm rim light, premium studio photography, clean background, 9:16, no text."], ["Hero reveal", "The product slowly emerges from darkness as the camera makes a subtle orbit and warm rim light travels across the bottle."], ["Material close-up", "Macro move along frosted glass as droplets roll down; focus travels to the cap and ends with clean copy space above."], ["Final product hold", "The product remains still with a locked camera and stable light. Leave safe space above and below for brand, price, and CTA text added in post. 9:16, no generated text."]],
    steps: ["Choose Start this tutorial in Create; OpenReel fills the current project with a 15-second product-ad example.", "Review the script and three 5-second shots; replace the sample product and pictures with simple words.", "If you need product consistency, upload one licensed front reference; OpenReel binds it to every shot automatically.", "Save the shots, confirm the total is 15 seconds, review the site owner's estimated cost, then decide whether to generate.", "When generation finishes, play the whole video, confirm all three shots appear with no black screen, then download the MP4."],
    checks: ["All three 5-second shots appear", "Product shape and color stay consistent", "There are no black or missing sections", "The whole video was played before download"]
  },
  "poetry-film": {
