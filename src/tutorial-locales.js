...
const EN = {
  ...
  "product-commercial": {
    ...
    steps: ["Add the blueprint to the current project, then replace the sample product on the Canvas.", "Choose Continue in Create; the same project, 15-second target, and three-shot plan are filled in for you.", "For consistency, upload a licensed front reference and bind it to all shots in one action.", "Save three 5-second shots, check that the total is exactly 15 seconds, then review the quote and explicitly confirm generation.", "Put the brand, price, and CTA in the final shot text, save, choose Create text cards from every shot’s text, then preview and download the MP4."],
