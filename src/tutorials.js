export const TUTORIALS = Object.freeze([
  ...
  },
  {
    ...
    steps: ["先把蓝图加入当前作品，再在画布把示例产品替换成你的真实产品。", "点击“继续到创作工作台”；同一作品、15 秒、三镜头方案会自动填好。", "如需一致性，上传一张有使用许可的正面参考图，并一键绑定到所有镜头。", "保存三段各 5 秒的分镜，检查总时长正好为 15 秒，再查看费用并明确确认生成。", "把品牌名、价格和 CTA 写进最终镜头文字，保存后点击“从每个镜头文字创建文字卡”，最后预览并下载 MP4。"],
