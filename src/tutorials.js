export const TUTORIALS = Object.freeze([
  ...
  {
    id: "product-commercial", version: 1, autoRun: false, title: "15 秒高级产品广告", category: "商业广告", level: "入门", duration: "约 15–25 分钟", calls: "1 张图 + 2 段视频", outcome: "完成一支包含英雄镜头、功能细节和品牌收尾的竖屏广告。",
    nodes: [
