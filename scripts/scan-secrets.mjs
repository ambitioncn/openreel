...
const secretValue = "[A-Za-z0-9_+\\/.=-]{20,}";
const patterns = [
  /-----BEGIN (?:RSA |EC |OPENSSH )?PRIVATE KEY-----/,
  new RegExp(`["'](?:api[_-]?key|password|secret|token)["']\\s*:\\s*["']${secretValue}["']`, "i"),
  new RegExp(`\\b(?:api[_-]?key|password|secret|token)\\b\\s*=\\s*["']${secretValue}["']`, "i"),
  /(?:^|[^A-Za-z0-9])(?:ghp_|github_pat_|sk-)[A-Za-z0-9_-]{20,}/
];
const findings = [];
